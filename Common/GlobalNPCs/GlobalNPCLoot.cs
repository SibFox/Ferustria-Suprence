    ...
    public class GlobalNPCLoot : GlobalNPC
    {
        ...
        public override void ModifyNPCLoot(NPC npc, NPCLoot npcLoot)
        {
            if (npc.type == NPCID.AngryBones || npc.type == NPCID.AngryBonesBig || npc.type == NPCID.AngryBonesBigHelmet || npc.type == NPCID.AngryBonesBigMuscle)
                npcLoot.Add(ItemDropRule.NormalvsExpert(ModContent.ItemType<Ceremonial_Knife_Piece>(), (int)(100/0.5), (int)(100/1)));
            if (npc.type == NPCID.DarkCaster)
                npcLoot.Add(ItemDropRule.NormalvsExpert(ModContent.ItemType<Ceremonial_Knife_Piece>(), (int)(100 / 1), (int)(100 / 1.7)));
        }
